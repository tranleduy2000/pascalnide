...
public interface DebugListener {
    ...
    void onAssignValue(LineInfo lineNumber, AssignableValue left, RuntimeValue value);

    void onPreFunctionCall(AbstractCallableFunction function, RuntimeValue[] arguments);

    void onFunctionCalled(AbstractCallableFunction function, RuntimeValue[] arguments, Object result);
}
