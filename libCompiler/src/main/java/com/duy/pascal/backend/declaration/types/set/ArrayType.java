...
package com.duy.pascal.backend.declaration.types.set;
...
public class ArrayType<ELEMENT extends DeclaredType> extends BaseSetType {
    ...
    /**
     * @param elementType
     * @param bound       - {@link com.duy.pascal.backend.declaration.types.subrange.IntegerSubrangeType} or
     *                    {@link com.duy.pascal.backend.declaration.types.subrange.EnumSubrangeType}
     */
