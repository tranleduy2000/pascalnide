...
class TermKeyEditableListener {
     ...
     */
    public TermKeyEditableListener() {
        initKeyCodes();
    }
...
//                Log.v("SpartacusRex","mapControlChar RELEASE CTRL from META");
            ...
            if (result > '0' && result <= '9') {
                int offs = (int) '1';
                result = KEYCODE_OFFSET + TermKeyEditableListener.KEYCODE_F1 + result - offs;
            } else if (result == '0') {
                result = KEYCODE_OFFSET + TermKeyEditableListener.KEYCODE_F10;
            } else if (result == 'o' || result == 'O') {
                result = KEYCODE_OFFSET + TermKeyEditableListener.KEYCODE_F11;
            } else if (result == 'p' || result == 'P') {
                result = KEYCODE_OFFSET + TermKeyEditableListener.KEYCODE_F12;
            }
...
//            Log.v("SpartacusRex","EMVIEW : FORW DELETE");
                result = KEYCODE_OFFSET + TermKeyEditableListener.KEYCODE_FORWARD_DEL;
                break;
