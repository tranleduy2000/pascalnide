...
public abstract class InAppPurchaseActivity extends BaseActivity implements IabBroadcastReceiver.IabBroadcastListener {
    ...
    public abstract void updateUiPremium();
    ...
    public void clickUpgrade() {
        ...
        mHandler.postDelayed(new Runnable() {
            @Override
            public void run() {
                mInAppPurchaseHelper.clickUpgrade();
            }
        }, 50);
    }
    ...
    public void showDialogUpgrade() {
        ...
        dialog.show(getSupportFragmentManager(), PremiumDialog.TAG);
    }
}
