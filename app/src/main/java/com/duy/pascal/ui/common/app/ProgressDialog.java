...
public class ProgressDialog extends Dialog implements ProgressInterface {
    ...
    private List<com.duy.pascal.ui.common.listeners.OnDismissListener> onDismissListeners;
    ...
    @Override
    public void addOnDismissListener(com.duy.pascal.ui.common.listeners.OnDismissListener listener) {
        ...
        super.setOnDismissListener(new OnDismissListener() {
            ...
            public void onDismiss(DialogInterface dialog) {
                ...
                for (com.duy.pascal.ui.common.listeners.OnDismissListener l : onDismissListeners) {
                    l.onDismiss();
                }
            }
        });
    ...
    @Override
    public void removeOnDismissListener(com.duy.pascal.ui.common.listeners.OnDismissListener listener) {
        if (onDismissListeners == null)
            return;
