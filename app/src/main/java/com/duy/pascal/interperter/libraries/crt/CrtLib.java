...
public class CrtLib extends PascalLibrary {
    ...
    public void declareConstants(ExpressionContextMixin context) {
        ...
        colorConst = new ConstantDefinition("Black", 0, new LineNumber(-1, "black = 0"));
        constants.put(colorConst.getName(), colorConst);
        colorConst = new ConstantDefinition("Blue", 1, new LineNumber(-1, "Blue = 1"));
        constants.put(colorConst.getName(), colorConst);
        colorConst = new ConstantDefinition("Green", 2, new LineNumber(-1, "Green = 2"));
        constants.put(colorConst.getName(), colorConst);
        colorConst = new ConstantDefinition("Cyan", 3, new LineNumber(-1, "Cyan = 3"));
        constants.put(colorConst.getName(), colorConst);
        colorConst = new ConstantDefinition("Red", 4, new LineNumber(-1, "Red = 4"));
        constants.put(colorConst.getName(), colorConst);
        colorConst = new ConstantDefinition("Magenta", 5, new LineNumber(-1, "Magenta = 5"));
        constants.put(colorConst.getName(), colorConst);
        colorConst = new ConstantDefinition("Brown", 6, new LineNumber(-1, "Brown = 6"));
        constants.put(colorConst.getName(), colorConst);
        colorConst = new ConstantDefinition("LightGray", 7, new LineNumber(-1, "LightGray  = 7"));
        constants.put(colorConst.getName(), colorConst);
        colorConst = new ConstantDefinition("DarkGray", 8, new LineNumber(-1, "DarkGray = 8"));
        constants.put(colorConst.getName(), colorConst);
        colorConst = new ConstantDefinition("LightBlue", 9, new LineNumber(-1, "LightBlue = 9"));
        constants.put(colorConst.getName(), colorConst);
        colorConst = new ConstantDefinition("LightGreen", 10, new LineNumber(-1, "LightGreen = 10"));
        constants.put(colorConst.getName(), colorConst);
        colorConst = new ConstantDefinition("LightCyan", 11, new LineNumber(-1, "LightCyan = 11"));
        constants.put(colorConst.getName(), colorConst);
        colorConst = new ConstantDefinition("LightRed", 12, new LineNumber(-1, "LightRed = 12"));
        constants.put(colorConst.getName(), colorConst);
        colorConst = new ConstantDefinition("LightMagenta", 13, new LineNumber(-1, "LightMagenta = 13"));
        constants.put(colorConst.getName(), colorConst);
        colorConst = new ConstantDefinition("Yellow", 14, new LineNumber(-1, " Yellow = 14"));
        constants.put(colorConst.getName(), colorConst);
        colorConst = new ConstantDefinition("White", 15, new LineNumber(-1, "White = 15"));
        constants.put(colorConst.getName(), colorConst);
