...
import com.duy.pascal.frontend.utils.clipboard.AndroidCompat;
...
class KeyEventListener {
    ...
    static boolean isEventFromToggleDevice(KeyEvent event) {
        ...
        KeyCharacterMapCompat kcm = KeyCharacterMapCompat.wrap(KeyCharacterMap.load(event.getDeviceId()));
...
//            mTermSession.write(result);
    ...
    public boolean handleKeyCode(int keyCode, KeyEvent event, boolean appMode) throws IOException {
        ...
        if (code != null) {
            ...
            Log.d(TAG, "Out: '" + ConsoleDebug.bytesToString(bytes, 0, bytes.length) + "'");
            // TODO: 26-Mar-17
