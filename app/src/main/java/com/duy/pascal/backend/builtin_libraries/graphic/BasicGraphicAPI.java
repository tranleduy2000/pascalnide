...
package com.duy.pascal.backend.builtin_libraries.graphic;
...
import com.duy.pascal.backend.builtin_libraries.graphic.model.ArcEllipseObject;
import com.duy.pascal.backend.builtin_libraries.graphic.model.ArcObject;
import com.duy.pascal.backend.builtin_libraries.graphic.model.Bar3DObject;
import com.duy.pascal.backend.builtin_libraries.graphic.model.BarObject;
import com.duy.pascal.backend.builtin_libraries.graphic.model.CircleObject;
import com.duy.pascal.backend.builtin_libraries.graphic.model.EllipseObject;
import com.duy.pascal.backend.builtin_libraries.graphic.model.FillEllipseObject;
import com.duy.pascal.backend.builtin_libraries.graphic.model.LineObject;
import com.duy.pascal.backend.builtin_libraries.graphic.model.PieSliceObject;
import com.duy.pascal.backend.builtin_libraries.graphic.model.PixelObject;
import com.duy.pascal.backend.builtin_libraries.graphic.model.PolygonObject;
import com.duy.pascal.backend.builtin_libraries.graphic.model.RectangleObject;
import com.duy.pascal.backend.builtin_libraries.graphic.model.SectorObject;
import com.duy.pascal.backend.builtin_libraries.graphic.model.TextGraphObject;
import com.duy.pascal.backend.builtin_libraries.graphic.paint.TextPaint;
import com.duy.pascal.backend.builtin_libraries.graphic.style.FillType;
import com.duy.pascal.backend.builtin_libraries.graphic.style.LineStyle;
import com.duy.pascal.backend.builtin_libraries.graphic.style.LineWidth;
...
public class BasicGraphicAPI implements PascalLibrary {
    ...
    public BasicGraphicAPI(@NonNull ConsoleHandler handler) {
