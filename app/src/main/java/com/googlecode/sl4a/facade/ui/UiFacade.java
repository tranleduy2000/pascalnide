...
package com.googlecode.sl4a.facade.ui;
...
public class UiFacade extends RpcReceiver {
    ...
    @PascalMethod(description = "Returns dialog response.")
    ...
    @PascalMethod(description = "Dismiss Full Screen.")
    ...
    @SuppressWarnings("unused")
    @PascalMethod(description = "Get Fullscreen Properties")
