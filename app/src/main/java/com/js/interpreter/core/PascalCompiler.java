...
public class PascalCompiler {
    ...
    public void amain() {
        ...
        try {
            ...
            String fileName = "C:\\Users\\Duy\\Documents\\pascalinterpreterinjava-master\\tests\\compare\\arraytest.pas";
...
//        System.out.println("Parse time = " + (System.currentTimeMillis() - beforetime) + " ms");
    ...
    public void debug(String sourcename, Reader in,
        ...
        PascalProgram pascalProgram = new PascalProgram(in, functionTable, sourcename, includeSearchPath);
        pascalProgram.run().run();
    }
