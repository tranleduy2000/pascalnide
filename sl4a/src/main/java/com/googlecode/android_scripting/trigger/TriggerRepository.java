...
public class TriggerRepository {
     ...
     *
     * @param trigger the {@link Trigger} to add
     */
    ...
    public interface TriggerRepositoryObserver {
         ...
         *
         * @param trigger The trigger about to be added to the repository.
         */
         ...
         *
         * @param trigger The trigger that has just been removed from the repository.
         */
